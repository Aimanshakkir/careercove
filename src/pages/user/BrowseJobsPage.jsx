...
//       <div className="flex-1 p-8 bg-gray-50 bg-hero h-[400px] min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
//         <div className="mb-8">
//           <h1 className="text-3xl font-bold text-[#66FCF1] mb-4">Browse the Caree you want</h1>
